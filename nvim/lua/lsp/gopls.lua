...
-- Comprehensive settings for Go development with code lenses and analyses
  ...
  settings = {                                         -- Settings for the language server
    gopls = {
      ...
      analyses = {
        ...
        useany = true,
        unreachable = true,
        -- Disable stylecheck to avoid duplicate messages
        stylecheck = false,
        appends = true,
        asmdecl = true,
        assign = true,
        ...
        fillreturns = true,
        framepointer = true,
        -- Disable gofix to avoid duplicate type inference messages
        gofix = false,
        hostport = true,
        infertypeargs = true,
        lostcancel = true,
        ...
        shift = true,
        sigchanyzer = true,
        -- Keep only one composite literal analyzer to avoid duplicates
